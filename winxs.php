...
<h1>WinXs - Unix like utilities for Windows (shareware)</h1>
Standard Windows does not provide a complete set of file and string manipulation utilities. There are plenty of 3rd party tools, but none seem to provide the single collection like WinXS.<br>
...
<h3>Gui based</h3>
Functionally these utilities work like their unix versions. WinXS has a Gui interface, so no need to remember command options details.
...
<ul>
 ...
 <li>Uniq - Writes one copy of each unique line.</li>
</ul>
<br><br>
